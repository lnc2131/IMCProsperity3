...
# =============================================================================
# Product Definitions (Using NEW Names)
# =============================================================================
class Product:
...
# =============================================================================
# Strategy Parameters (Separated Shared and Specific)
# =============================================================================

# Shared parameters for vouchers (time, rate, global fallback sigma)
SHARED_VOUCHER_PARAMS = {
     "r": 0.0,                       # Risk-free rate
     "global_fallback_sigma": 0.20,  # Fallback volatility if ATM IV calculation fails ** TUNE THIS **
...
PARAMS = {
    ...
    Product.VOLCANIC_ROCK_VOUCHER_9500: {
        "trade_threshold_abs": 2, "exit_threshold_abs": 1, "base_order_size_voucher": 20,
    },
    Product.VOLCANIC_ROCK_VOUCHER_9750: {
        "trade_threshold_abs": 2, "exit_threshold_abs": 1, "base_order_size_voucher": 20,
    },
    Product.VOLCANIC_ROCK_VOUCHER_10000: {
        "trade_threshold_abs": 1, "exit_threshold_abs": 0.5, "base_order_size_voucher": 20,
    },
    Product.VOLCANIC_ROCK_VOUCHER_10250: {
        "trade_threshold_abs": 2, "exit_threshold_abs": 0.75, "base_order_size_voucher": 20,
    },
    Product.VOLCANIC_ROCK_VOUCHER_10500: {
        "trade_threshold_abs": 1.75, "exit_threshold_abs": 1, "base_order_size_voucher": 20,
    },
}
...
LIMIT = {
    ...
    Product.DJEMBES: 60, Product.VOLCANIC_ROCK: 400,
